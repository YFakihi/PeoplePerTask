...
create TABLE testimonial (
	ID int PRIMARY KEY auto_increment ,
	testimonial_Message varchar(255),
	ID_User int,
    foreign key (ID_User) references Users(ID) ON DELETE CASCADE ON UPDATE cascade
);
...
CREATE TABLE Sub_Categories (
  ...
  ID_Categorie int,
  FOREIGN KEY (ID_Categorie) REFERENCES Sub_Categories(ID) 
);
...
CREATE TABLE Projets (
  ...
  foreign key (ID_User) references Users(ID) ON DELETE CASCADE ON UPDATE cascade,
  FOREIGN KEY (ID_sub_Categorie) REFERENCES Sub_Categories(ID) ON DELETE CASCADE ON UPDATE cascade
);
...
create TABLE Offres (
  ...
  ID_Freelance int,
  ID_Project int,
  FOREIGN KEY (ID_Project) REFERENCES Projets(ID) ON DELETE CASCADE ON UPDATE CASCADE ,
  FOREIGN KEY (ID_Freelance) REFERENCES Freelances(ID) ON DELETE CASCADE ON UPDATE cascade
);
...
INSERT INTO users (Name_user, Password_user, email, birthday,city) 
VALUES 
('Ahmed Hassan', 'ahmedpass123', 'ahmed.h@example.com', '1992-07-20',1),
('Fatima Zahra', 'fatimapass456', 'fatima.z@example.com', '1988-04-12',2),
('Youssef Ali', 'youssefpass789', 'youssef.a@example.com', '1995-10-05',5),
('Nora Amrani', 'norapass321', 'nora.a@example.com', '1990-12-30',3),
('Mehdi Belhaj', 'mehdipass654', 'mehdi.b@example.com', '1985-09-18',5);
...
INSERT INTO testimonial (testimonial_Message, ID_User)
VALUES 
...
INSERT INTO Sub_Categories (Name_categories,ID_Categorie)
VALUES 
('Web Development',1),('Graphic Design',2),('Content Writing',3),('Digital Marketing',4),('Data Analysis',5);

INSERT INTO Projets (Title, Description_project, ID_User, ID_sub_Categorie)
VALUES 
('Website Development', 'Building an e-commerce website', 1,  1),
('Logo Design', 'Creating a brand logo', 2, 2),
('Content Writing for Blog', 'Writing articles for a blog', 3,  3),
('Digital Marketing Campaign', 'Running a social media campaign', 4,  4),
('Data Analysis for Sales', 'Analyzing sales data for insights', 5,  5);
