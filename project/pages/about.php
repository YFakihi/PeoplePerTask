            ...
            <div class="row g-0 bg-body-secondary position-relative bg-body">
                ...
                <div class="col-md-6 align-items-center p-5 bg-body">
                    ...
                    <div class="hero-button">
                        <a class="btn btn-primary primary-btn-orange" href="#">READ MORE</a>
                    </div>
                    </div>
                </div>
            </div>  
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                <img src="images/929-1697015899.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Boat on Calm Water"/>
                                <img src="images/12-1665938441.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Wintry Mountain Landscape"/>
                            </div>
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                <img src="images/878-1697126932.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Mountains in the Clouds"/>
                                <img src="images/885-1697015839.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Boat on Calm Water"/>
                            </div>
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                <img src="images/908-1697015832.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Waves at Sea"/>
                                <img src="images/926-1697015817.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Yosemite National Park"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 col-12 fs-1">
                            ...
                            <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512"><style>svg{fill:#ff8000}</style><path d="M0 64C0 46.3 14.3 32 32 32H96h64 64c17.7 0 32 14.3 32 32s-14.3 32-32 32V266.8c-20.2 28.6-32 63.5-32 101.2c0 25.2 5.3 49.1 14.8 70.8C189.5 463.7 160.6 480 128 480c-53 0-96-43-96-96V96C14.3 96 0 81.7 0 64zM96 96v96h64V96H96zM224 368a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm211.3-43.3c-6.2-6.2-16.4-6.2-22.6 0L352 385.4l-28.7-28.7c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6l40 40c6.2 6.2 16.4 6.2 22.6 0l72-72c6.2-6.2 6.2-16.4 0-22.6z"/></svg></i></div> 
                                <!-- icon -->
                            <h3 class="fw-bold">Our principles</h3>
                            <p>Anyone can suggest new principles or challenge existing ones. 
                            </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="mb-6 mb-lg-0 fs-6">
                            <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 640 512"><style>svg{fill:#ff8000}</style><path d="M48 48h88c13.3 0 24-10.7 24-24s-10.7-24-24-24H32C14.3 0 0 14.3 0 32V136c0 13.3 10.7 24 24 24s24-10.7 24-24V48zM175.8 224a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm-26.5 32C119.9 256 96 279.9 96 309.3c0 14.7 11.9 26.7 26.7 26.7h56.1c8-34.1 32.8-61.7 65.2-73.6c-7.5-4.1-16.2-6.4-25.3-6.4H149.3zm368 80c14.7 0 26.7-11.9 26.7-26.7c0-29.5-23.9-53.3-53.3-53.3H421.3c-9.2 0-17.8 2.3-25.3 6.4c32.4 11.9 57.2 39.5 65.2 73.6h56.1zm-89.4 0c-8.6-24.3-29.9-42.6-55.9-47c-3.9-.7-7.9-1-12-1H280c-4.1 0-8.1 .3-12 1c-26 4.4-47.3 22.7-55.9 47c-2.7 7.5-4.1 15.6-4.1 24c0 13.3 10.7 24 24 24H408c13.3 0 24-10.7 24-24c0-8.4-1.4-16.5-4.1-24zM464 224a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm-80-32a64 64 0 1 0 -128 0 64 64 0 1 0 128 0zM504 48h88v88c0 13.3 10.7 24 24 24s24-10.7 24-24V32c0-17.7-14.3-32-32-32H504c-13.3 0-24 10.7-24 24s10.7 24 24 24zM48 464V376c0-13.3-10.7-24-24-24s-24 10.7-24 24V480c0 17.7 14.3 32 32 32H136c13.3 0 24-10.7 24-24s-10.7-24-24-24H48zm456 0c-13.3 0-24 10.7-24 24s10.7 24 24 24H608c17.7 0 32-14.3 32-32V376c0-13.3-10.7-24-24-24s-24 10.7-24 24v88H504z"/></svg></div>
                            <h3 class="fw-bold">Speed matters</h3>
                            <p>Moving quickly allows us to test things, learn, and iterate.
                            </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 col-12">
        ...
        <!-- row -->
            <div class="row justify-content-center">
                ...
                <div class="card mb-4 card-hover">
                    ...
                    <img src="images/857-1697015907.jpg" alt="" class="rounded-top-md img-fluid">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                    <h3 class="mb-0 fw-semibold"> <a href="#" class="text-inherit text-half-orange-effect">Soulaiman Bouhlal</a></h3>
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div class="card-img-top">
                    <img src="images/921-1697015877.jpg" alt="" class="rounded-top-md img-fluid">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                    <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit text-half-orange-effect">Mohamed Miessal</a></h3>
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div class="card-img-top">
                    <img src="images/923-1697015917.jpg" alt="" class="rounded-top-md img-fluid">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                    <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit text-half-orange-effect">Wissal Baaziz</a></h3>
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div class="card-img-top">
                    <img src="images/946-1697015937.jpg" alt="" class="rounded-top-md img-fluid">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                    <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit text-half-orange-effect">Yassine Elouissi</a></h3>
