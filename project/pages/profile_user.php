      ...
      <div class="col-md-6 offset-md-3">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Skills: skil1</p>
          ...
          <img src="images/circle orange.svg" class="mr-3 rounded-circle" alt="Reviewer Image">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                      <form action="./qpplypro.php" method="POST">
                          <input type="hidden" name="id" value="<?= $row['id'] ?>">
                        
                          <button class="btn btn-primary me-2 sign-style-color">ACCept</button>  
...
<?php
          ...
          ?>
<h5 class="card-title">Your Offers:</h5>
...
<table id="example" class="table table-striped" style="width:100%">
              ...
              <tbody>
                ...
                if (isset($_SESSION['id'])) {
                  ...
                  $query = "SELECT * FROM proposel WHERE statu = 1";;
